...
?>
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
                      <?php
                            $message = Session::get('update-message');
                            if($message){
                                echo '<span class="text-success">'.$message.'</span>';
                                Session::put('update-message',null);
                            }
                      ?>
                      <?php
                            $message = Session::get('delete-message');
                            if($message){
                                echo '<span class="text-success">'.$message.'</span>';
                                Session::put('delete-message',null);
                            }
                      ?>
                      <?php
                            ...
                            if($message){
                                echo '<span class="text-success">'.$message.'</span>';
                                Session::put('status-message',null);
                            }
                      ?>
