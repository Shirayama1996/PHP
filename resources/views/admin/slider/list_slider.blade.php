        ...
        ?>
          <tr>
            ...
            <td><span class="text-ellipsis">
                ...
                ?>
                    <a href="{{URL::to('/unactive-slider/'.$slider->slider_id)}}"><span class="fa-icon-styling icon-smile"></span></a>
                    <?php
                }
                else{
                ?>
                    <a href="{{URL::to('/active-slider/'.$slider->slider_id)}}"><span class="fa-icon-styling fa fa-frown-o"></span></a>
                    <?php
                }
                ?>
            </span></td>
