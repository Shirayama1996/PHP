  ...
  <div class="panel panel-default">
    ...
    ?>
      <table class="table table-striped b-t b-light">
        ...
        <?php
            $stt = 0;
            foreach($search_product_manufacturer as $key => $pm):
            $stt++;
        ?>
          <tr>
            <td>{{$stt}}</td>
            ...
            <td><span class="text-ellipsis">
                ...
                ?>
                    <a href="{{URL::to('/unactive-product-manufacturer/'.$pm->manufacturer_id)}}"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                    <?php
                }
                else{
                ?>
                    <a href="{{URL::to('/active-product-manufacturer/'.$pm->manufacturer_id)}}"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                    <?php
                }
                ?>
            </span></td>
