  ...
  <div class="panel panel-default">
    ...
    ?>
      <table class="table table-striped b-t b-light">
        ...
        <?php
            $stt = 0;
            foreach($search_product_category as $key => $pc):
            $stt++;
        ?>
          <tr>
            <td>{{$stt}}</td>
            ...
            <td><span class="text-ellipsis">
                ...
                ?>
                    <a href="{{URL::to('/unactive-product-category/'.$pc->category_id)}}"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                    <?php
                }
                else{
                ?>
                    <a href="{{URL::to('/active-product-category/'.$pc->category_id)}}"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                    <?php
                }
                ?>
            </span></td>
