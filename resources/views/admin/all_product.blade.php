        ...
        ?>
          <tr>
            ...
            <td>
                ...
                ?>
                    <a href="{{URL::to('/unactive-product/'.$pro->product_id)}}"><span class="fa-icon-styling icon-smile"></span></a>
                    <?php
                }
                else{
                ?>
                    <a href="{{URL::to('/active-product/'.$pro->product_id)}}"><span class="fa-icon-styling fa fa-frown-o"></span></a>
                    <?php
                }
                ?>
            </td>
